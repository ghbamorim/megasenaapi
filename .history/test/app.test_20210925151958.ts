...
test("result 123", async () => {
  ...
  expect(res.body.coluna_1).not.toBeNaN;
  expect(res.bodycoluna_2).not.toBeNaN;
  expect(res.body.coluna_3).not.toBeNaN;
  expect(res.body.coluna_4).not.toBeNaN;
  expect(res.body.coluna_5).not.toBeNaN;
  expect(res.body.coluna_6).not.toBeNaN;
});
/*
